...
urlpatterns = [
    ...
    path('api/decrement_cart/<int:product_id>/<int:cart_item_id>/', api_view.DecrementCart.as_view(), name='decrement_cart_api'),
    path('api/delete_cart/<int:product_id>/<int:cart_item_id>/', api_view.DeleteCartItem.as_view(), name='delete_cart_api'),
    path('api/checkout/', api_view.CheckoutAPIView.as_view(), name='checkout_api'),
